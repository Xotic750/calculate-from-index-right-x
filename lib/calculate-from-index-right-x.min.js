 ...
 */
"use strict";var toObject=_dereq_("to-object-x"),toLength=_dereq_("to-length-x").toLength2018,toInteger=_dereq_("to-integer-x").toInteger2018,isArrayLike=_dereq_("is-array-like-x"),getMin=function _getMin(a,b){return a<=b?a:b};module.exports=function calcFromIndexRight(array,fromIndex){var object=toObject(array);if(!1===isArrayLike(object))return 0;var length=toLength(object.length),index=getMin(toInteger(fromIndex),length-1);return index>=0?index:length+index}},{"is-array-like-x":7,"to-integer-x":29,"to-length-x":30,"to-object-x":32}],2:[function(_dereq_,module,exports){/**
